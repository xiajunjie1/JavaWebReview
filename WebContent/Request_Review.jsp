...
<%
/*
	利用getParameterNames和getParameterValues动态获取多个请求参数
...
Enumeration<String> enu=request.getParameterNames();
 while(enu.hasMoreElements()){
	 ...
	 String[] paravalue=request.getParameterValues(name);
 ...
 /*
 可以通过下面的方法取代上面的代码实现动态获取参数
 用该方式实现，效果和性能会更好
 */
Map<String,String[]>pmap=request.getParameterMap();
for(Map.Entry<String,String[]> entry: pmap.entrySet()){
	%>
	<h2>参数名：<%=entry.getKey()%> 参数值：<%=Arrays.toString(entry.getValue()) %></h2>
<% 
}
%>
